    ...
    do { // cycles (actually instructions)
        ...
        while (true) { // loop over instruction bytes (fetch)
            ...
            case 0x6b: // IMUL
                ...
                v = sign_extend_byte(fetch_data8());
                aux_IMUL(rm, v);
                regs[reg] = u;
                goto FETCH_LOOP;
            case 0x84: // TEST
            ...
            case 0xe1: // LOOPE
            case 0xe2: // LOOP
                w = sign_extend_byte(fetch_data8());
            ...
            case 0xe3: // JCXZ
                ...
                goto FETCH_LOOP;
            case 0xc2: // RET
                u = sign_extend_word(fetch_data16());
                m = ld_stack();
                ...
                case 0x10f: // 2-byte instruction escape
                    ...
                    case 0x1ad: // SHRD
                        ...
                        if ((modRM >> 6) == 3) {
                            ...
                            segment_translation();
                            rm = ld16_writable_cpl3();
                            u = aux_SHRD16_SHLD16(rm, r, regs[1]);
                            st16_writable_cpl3(u);
                        }
                        goto FETCH_LOOP;
                    case 0x1ba: // G8 (-, -, -, -, BT, BTS, BTR, BTC)
                        ...
                        case 7:
                            ...
                            if ((modRM >> 6) == 3) {
                                ...
                                imm = fetch_data8();
                                rm = ld16_writable_cpl3();
                                u = aux_BTS16_BTR16_BTC16(rm, imm);
                                st16_writable_cpl3(u);
                            }
                            break;
                        default:
