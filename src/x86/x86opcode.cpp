    ...
    do {
        ...
        while (true) {
            ...
            case 0x38: // CMP
                ...
                if ((mem8 >> 6) == 3) {
                    reg_idx0 = mem8 & 7;
                    set_lower_byte(reg_idx0, do_8bit_math(operation, (regs[reg_idx0 & 3] >> ((reg_idx0 & 4) << 1)), y));
                } else {
                    mem8_loc = segment_translation(mem8);
                    if (operation != 7) {
                        x = ld_8bits_mem8_write();
            ...
            case 0x3a: // CMP
                ...
                set_lower_byte(reg_idx1, do_8bit_math(operation, (regs[reg_idx1 & 3] >> ((reg_idx1 & 4) << 1)), y));
                goto EXEC_LOOP;
            case 0x03: // ADD
                mem8 = phys_mem8[far++];
                reg_idx1 = (mem8 >> 3) & 7;
            ...
            case 0x3c: // CMP
                y = phys_mem8[far++];
                operation = opcode >> 3;
                set_lower_byte(0, do_8bit_math(operation, regs[0] & 0xff, y));
                goto EXEC_LOOP;
            case 0x05: // ADD
                y = phys_mem8[far] |
                    (phys_mem8[far + 1] << 8) |
            ...
            case 0xf6: // G3 (TEST, -, NOT, NEG, MUL AL/X, IMUL AL/X, DIV AL/X, // IDIV AL/X)
                ...
                case 3:
                    if ((mem8 >> 6) == 3) {
                        reg_idx0 = mem8 & 7;
                        set_lower_byte(reg_idx0, do_8bit_math(5, 0, (regs[reg_idx0 & 3] >> ((reg_idx0 & 4) << 1))));
                    } else {
                        mem8_loc = segment_translation(mem8);
                        x = ld_8bits_mem8_write();
            ...
            case 0xc0: // G2 (ROL ROR RCL RCR SHL SHR SAL SAR)
                ...
                if ((mem8 >> 6) == 3) {
                    y = phys_mem8[far++];
                    reg_idx0 = mem8 & 7;
                    set_lower_byte(reg_idx0, shift8(operation, (regs[reg_idx0 & 3] >> ((reg_idx0 & 4) << 1)), y));
                } else {
                    mem8_loc = segment_translation(mem8);
                    y = phys_mem8[far++];
                    x = ld_8bits_mem8_write();
            ...
            case 0xd0: // G2 (ROL ROR RCL RCR SHL SHR SAL SAR),1
                ...
                if ((mem8 >> 6) == 3) {
                    reg_idx0 = mem8 & 7;
                    set_lower_byte(reg_idx0, shift8(operation, (regs[reg_idx0 & 3] >> ((reg_idx0 & 4) << 1)), 1));
                } else {
                    mem8_loc = segment_translation(mem8);
                    x = ld_8bits_mem8_write();
            ...
            case 0xfe: // G4 (INC, DEC, -, -, -, -, -)
                ...
                case 0:
                    if ((mem8 >> 6) == 3) {
                        reg_idx0 = mem8 & 7;
                        set_lower_byte(reg_idx0, increment_8bit((regs[reg_idx0 & 3] >> ((reg_idx0 & 4) << 1))));
                    } else {
                        mem8_loc = segment_translation(mem8);
                        x = ld_8bits_mem8_write();
                        x = increment_8bit(x);
                ...
                case 1:
                    if ((mem8 >> 6) == 3) {
                        reg_idx0 = mem8 & 7;
                        set_lower_byte(reg_idx0, decrement_8bit((regs[reg_idx0 & 3] >> ((reg_idx0 & 4) << 1))));
                    } else {
                        mem8_loc = segment_translation(mem8);
                        x = ld_8bits_mem8_write();
                        x = decrement_8bit(x);
