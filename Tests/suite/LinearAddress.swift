...
func linearAddressFieldsAccess() {
    ...
    #expect(linearAddress.pageDirectoryOffset == 0b11_0111_101000)
    #expect(linearAddress.pageTableOffset     == 0b10_1101_110000)
    ...
    #expect(linearAddress.pageDirectoryOffset == 0b10_1111_101000)
    #expect(linearAddress.pageTableOffset     == 0b10_1111_110000)
